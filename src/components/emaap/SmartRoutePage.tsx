  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        description="Automated multi-factor inspection sequence generator. Dispatches pending verification requests within 10 km of your physical location, scored by priority, pendency, and proximity."
      />
      ...
      {!routes && (
        <div className="rounded-2xl border border-slate-200 bg-white p-8 sm:p-12 shadow-sm text-center max-w-[760px] mx-auto my-6">
          ...
          <p className="mt-2.5 text-[14px] text-slate-600 leading-relaxed max-w-[560px] mx-auto">
            ...
            inspection sequence of up to 6 priority commercial sites within a 10-kilometer radius.
          </p>
            ...
            <div className="lg:col-span-6 space-y-3">
                ...
                <div className="px-4 py-3 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="text-[11px] font-semibold bg-white">
                      Top {routes.length} of {totalFound} within 10km
                    </Badge>
                  </div>
                </div>
                ...
                {routes.length === 0 ? (
                  <div className="p-8 text-center">
                    ...
                    <h4 className="text-[14px] font-bold text-slate-800">
                      No Pending Sites Within 10 km
                    </h4>
                    <p className="mt-1 text-[12.5px] text-slate-500 max-w-[340px] mx-auto">
                      There are no pending verification requests within 10 kilometers of your current GPS position.
                    </p>
                    <Button
                      variant="outline"
                      size="sm"
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50/70 p-3.5 text-[12px] text-slate-600 flex items-start gap-2.5">
                ...
                <p className="leading-relaxed">
                  <strong>GIS Optimization Logic:</strong> Filtered to pending requests within 10 km of your starting location. Sites were scored by Priority (up to 50 pts), Pendency (up to 30 pts), and Proximity (up to 20 pts). The sequence is generated by greedy nearest-neighbor navigation starting from your position.
                </p>
              </div>
            </div>
